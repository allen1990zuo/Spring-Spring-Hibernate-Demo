...
public class NewsTypeDAOImpl implements NewsTypeDAO {
	public NewsTypeDAOImpl(){
		System.out.println("ππ‘ÏNewsTypeDAO");
	}
	...
	@Override
	public List<NewsType> findAll(Pager pager) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<NewsType> findAll(Pager pager, NewsType object) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public static void main(String[] args) {
		...
		//NewsTypeDAO dao = ac.getBean("NewsTypeDAO",NewsTypeDAO.class);
		NewsTypeDAO dao = (NewsTypeDAO)ac.getBean("NewsTypeDAO");
		
		NewsType newsType = new NewsType();
		newsType.setTitle("aaa");
		dao.save(newsType);
